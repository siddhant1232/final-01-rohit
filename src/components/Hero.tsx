  ...
  return (
    <section id="home" className="py-16 md:py-24">
      ...
      <div className="container mx-auto px-4 mt-24">
        <figure className="max-w-2xl mx-auto border border-accent p-8 relative text-center md:text-left">
          <blockquote className="text-2xl font-medium text-accent">
            "With deep learning comes shallow sleep"
          </blockquote>
          <figcaption className="text-right mt-4 text-accent">- Dr. Who</figcaption>
